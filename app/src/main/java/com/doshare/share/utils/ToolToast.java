...
public class ToolToast {
    ...
    private static Handler mHandler = ToolUI.getMainThreadHandler();
    ...
    public static void showLong(String msg) {
        buildToast(MyApp.getContext(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showShort(String msg) {
        buildToast(MyApp.getContext(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static Toast buildToast(Context context, String msg, int duration, String bgColor, int textSp, int cornerRadius) {
        ...
        int dpPadding = ToolUI.dip2Px(10);
