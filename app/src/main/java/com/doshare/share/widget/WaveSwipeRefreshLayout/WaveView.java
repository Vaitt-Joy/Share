package com.doshare.share.widget.WaveSwipeRefreshLayout;
...
public class WaveView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    /**
     * {@link WaveView#mDropBounceVerticalAnimator}  和 {@link WaveView#mDropBounceHorizontalAnimator}
     * 的Duration
     */
    private static final long DROP_BOUNCE_ANIMATOR_DURATION = 500;

    /**
     * {@link WaveView#mDisappearCircleAnimator} 的Duration
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(ToolUI.getColor(R.color.primary_light));
        ...
        mPaint.setColor(ToolUI.getColor(R.color.orange));
